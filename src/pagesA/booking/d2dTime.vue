...
async function save() {
  await request.put(`/business/store-to-door-time`, {
...
<template>
  <view px-20px py-12px f12 lh-18px c-FF6619 bg-FFEFE6>
    可服务时间指的是您可上门服务的时间，该时间内您需要及时响应用户上门服务的新订单。设置与您服务能力相符的服务时间可以降低取消率，提高店铺业绩。
  </view>
  ...
  <MyCellGroup>
    <MyCell label="每天可服务时段" @myclick="showPicker">
      <text f14 c-3B3D3D>
        {{ value1 }}-{{ value2 }}
      </text>
    </MyCell>
